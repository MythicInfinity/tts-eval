...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run DNSMOS overall over model directories.")
...
def main() -> int:
    ...
    for index, model_input in enumerate(models, start=1):
        ...
        metadata_payload = build_metadata_payload(runtime.metric_version, runtime.personalized)
