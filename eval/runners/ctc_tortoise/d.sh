...
IMAGE_NAME="${IMAGE_NAME:-tts-eval-ctc-tortoise}"
...
DEVICE="${TORTOISE_CTC_DEVICE:-cuda}"
...
TIMESTAMP="${3:-}"
OUTPUT_DIR="/app/data/evals/ctc_tortoise"
...
docker_args=(
  ...
  "${IMAGE_NAME}"
  python
  /app/eval/runners/ctc_tortoise/run_inner.py
  --inputs
  /inputs
  --refs
  /refs
